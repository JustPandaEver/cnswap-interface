...
const CODE_LINK = 'https://github.com/JustPandaEver/cnswap-interface'
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          ...
          <MenuItem id="link" href="https://cnswap.gitbook.io/cnswap/">
            <BookOpen size={14} />
          ...
          <MenuItem id="link" href="https://t.me/cnswap">
